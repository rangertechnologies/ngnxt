...
export const TESTQB: QuestionBook = {
  ...
  RFAB__Possibilities__c: "path",
  RFAB__Summary_Sub_Text__c : "",
  RFAB__Summary_Text__c :"",
...
export const TESTQUESTION: Question = {
  ...
  RFAB__Time_Text__c: "Zeit",
  RFAB__Title__c: "Test",
  RFAB__SubTitle__c: "Subtitle",
  RFAB__Date_Text__c: "Datum",
  ...
  RFAB__Sub_Text__c : "Necesitamos que confirmes la titularidad de la cuenta.",
  RFAB__Size__c: 1,
